    ...
    <View className="flex flex-col w-full">
      <View className="flex flex-row w-full">
        ...
        <View className="flex flex-row ml-[5%] justify-around w-3/4">
          <Animated.View style={{ opacity }} className="flex-col justify-center items-center flex-1">
      ...
      <View className="flex flex-row justify-between py-[5%]">
        ...
        <Animated.View style={{ opacity }} className="flex-1 justify-center items-center">
