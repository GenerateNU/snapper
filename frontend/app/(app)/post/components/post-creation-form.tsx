    ...
    <FormProvider {...methods}>
      <ScrollView showsVerticalScrollIndicator={false} className="flex flex-col space-y-2 w-[90vw]">
        <View className="flex flex-col justify-items items-center pt-[10vh]">
          ...
          <Text className="font-normal text-[12px] leading-[18px]">
            {' '}
        ...
        <View className="h-fit w-full flex flex-row justify-between items-center mb-4">
          ...
          <View className="w-fit">
            <Input title={'Dive Location'} placeholder={'42 Wallaby Way'} />
          </View>
        </View>
        <ImagePicker />
        ...
        <Text className="font-semibold text-[14px] pt-[2vh]">
          Dive Description
        </Text>
        <Text className="font-normal text-[12px] leading-[18px]">
          Highlight memorable moments or explorations
        </Text>
        <View className="mb-4">
